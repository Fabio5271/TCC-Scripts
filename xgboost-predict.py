...
renames = {
    ...
    'temp_var_ext_10d':     'Var. temp. mín-máx últ. 10d',
    ...
    'umd_min_10d':          'Umidade rel. mín. últ. 10d',
    'umd_min_15d':          'Umidade rel. mín. últ. 15d',
    'umd_r_max_pct':        'Umidade rel. máx.',
    'vento_dir_gr':         'Vento, direção média',
    'vento_vel_mps':        'Vento, velocidade média',
    'vento_vel_med_5d':     'Vento, vel. méd. últ. 5d',
    'vento_vel_med_10d':    'Vento, vel. méd. últ. 10d',
    'vento_vel_med_15d':    'Vento, vel. méd. últ. 15d',
    'vento_vel_med_30d':    'Vento, vel. méd. últ. 30d',
    'vento_raj_max_mps':    'Vento, rajada máxima',
    'vento_raj_max_5d':     'Vento, rajada máx. últ. 5d',
...
for lag in [1, 3, 7]:
    merged_df[f'Nr de Internações (Lag {lag})'] = merged_df['cases'].shift(lag)
    merged_df[f'Temperatura do ar (Lag {lag})'] = merged_df[renames['temp_seco_c']].shift(lag)
