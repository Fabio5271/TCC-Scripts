...
df_daily.insert(temp_max_idx + 5, 'temp_var_med_10d', avg_temp_var_last_10)
df_daily.insert(temp_max_idx + 6, 'temp_var_ext_10d', xtr_temp_var_last_10)
...
df_daily.insert(df_daily.columns.get_loc('umd_r_min_pct') + 1, 'umd_min_10d', min_hum_last_10)
df_daily.insert(df_daily.columns.get_loc('umd_r_min_pct') + 2, 'umd_min_15d', min_hum_last_15)
# df_daily.insert(df_daily.columns.get_loc('umd_r_max_pct') + 5, 'umd_max_10d', max_hum_last_10)
df_daily.insert(df_daily.columns.get_loc('precip_max_mm') + 1, 'precip_med_10d', avg_prec_last_10)
df_daily.insert(df_daily.columns.get_loc('press_max_mb') + 1, 'press_med_10d', avg_press_last_10)
df_daily.insert(df_daily.columns.get_loc('vento_vel_mps') + 1, 'vento_vel_med_5d', avg_wind_last_5)
df_daily.insert(df_daily.columns.get_loc('vento_vel_mps') + 2, 'vento_vel_med_10d', avg_wind_last_10)
df_daily.insert(df_daily.columns.get_loc('vento_vel_mps') + 3, 'vento_vel_med_15d', avg_wind_last_15)
df_daily.insert(df_daily.columns.get_loc('vento_vel_mps') + 4, 'vento_vel_med_30d', avg_wind_last_30)
df_daily.insert(df_daily.columns.get_loc('vento_raj_max_mps') + 1, 'vento_raj_max_5d', max_wind_last_5)
